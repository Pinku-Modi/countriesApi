    ...
    return (
        ...
        */
        ...
        <div className={`cardContainer`}>
            <Card sx={{
                minWidth: 250, backgroundColor: themeFromStore === "dark" ? 'black' : 'white', color: themeFromStore === "dark" ? 'white' : 'black' }}>
                ...
                <CardContent>
                    ...
                    <Typography variant="body2" sx={{ color: themeFromStore === "dark" ? 'white' : 'black' }}>
                        <span className="font-semibold">Population:</span> {props.population.toLocaleString()}
                    </Typography>
                    <Typography variant="body2" sx={{ color: themeFromStore === "dark" ? 'white' : 'black' }}>
                        <span className="font-semibold">Region:</span> {props.region}
