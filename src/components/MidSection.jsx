...
import { SET_COUNTRY } from "../store/countries.slice";
    ...
    return (
        <div className="flex justify-between content-center my-6 w-full ">
            <div className="flex gap-2 bg-white ml-14 w-1/4 min-h-min px-2 py-1">
                ...
                <input type="search" placeholder="Search for a country..." className="bg-white border-none focus:outline-none font-sans text-base font-[600] h-full w-full" onChange={(e)=>{handleSearch(e)}} />
            </div>
